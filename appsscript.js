...
function onFormSubmit(e) {
  ...
  var datos = {
    ...
    FechaVencimientoSoat: limpiarCampoFecha(datosFila[9]),
    FechaVencimientoRevision: limpiarCampoFecha(datosFila[10]),
    FechaVencimientoLicencia: limpiarCampoFecha(datosFila[11]),
